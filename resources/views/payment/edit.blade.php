    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('payments.update', ['payment' => $payment->id]) }}">
                        @csrf
                        <div class="mt-6">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <select id="email" type="email"
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->email }}" @if($customer->email === $payment->customer_email) selected @endif>{{ $customer->email }}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="amount" type="number" name="amount" value="{{ $payment->amount }}" required
                                       autocomplete="amount"
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="date" type="date" name="date" value="{{ $payment->date }}" required
                                       autocomplete="date"
